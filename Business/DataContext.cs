...
namespace Business
{
    public class DataContext : DbContext
    {
        ...
        public DbSet<AdvertiseArea> AdvertiseAreas { get; set; }
...
new Restaurant("	Mandarin	", "	0142-17700	", @"Lunch serveras mellan 11:00-15:00, pris 75:- inkl. sallad, dryck, smör, bröd & kaffe. Lunchkuponger 10st 650:-
 ...
 Tel: 0142-17700", "")
            ...
            AdminManager.CreateLunchArea(l1);
            AdminManager.CreateLunchArea(l2);
            AdminManager.CreateLunchArea(l3);


            #region companies
            var comps = new List<Company> {
                new Company {
                        Name = "01Blåklintsbuss AB", Url = "http://mjolbylunch.se", Information = "Lite företagsinfo..."  
                    },
                    new Company {
                        Name = "02Blåklintsbuss AB", Url = "http://mjolbylunch.se", Information = "Lite företagsinfo..."  
                    },
                    new Company {
                        Name = "03Blåklintsbuss AB", Url = "http://mjolbylunch.se", Information = "Lite företagsinfo..."  
                    },
                    new Company {
                        Name = "04Blåklintsbuss AB", Url = "http://mjolbylunch.se", Information = "Lite företagsinfo..."  
                    },
            };
            ...
            using (var db = new DataContext())
            {
                ...
                {
                    var image = ImageManager.CreateImage("blaklintsbuss_20120929.gif");
                    AdvertiseManager.CreateAdvertise(comp, new List<LunchArea> {l1, l2}, image);
                    image = ImageManager.CreateImage("elda_20120323.gif");
                    AdvertiseManager.CreateAdvertise(comp, new List<LunchArea> {l1, l2}, image);

                    //new Advertise() { Image = "jockes_20091112.gif" , 
                    //     Area = new AdvertiseArea { Company = new Company() {Name = "Jockes", Url = "http://mjolbylunch.se", Information = "Lite företagsinfo..." }, LunchAreas = {l1, l2} } },

                    //new Advertise() {Image = "bostadsbolaget_20110916.gif" , 
                    //     Area = new AdvertiseArea { Company = new Company() {Name = "Bostadsbolaet AB", Url = "http://mjolbylunch.se", Information = "Lite företagsinfo..." }, LunchAreas = {l1} } },
                    ...
                    //     new Advertise() { Image = 
                    //     "mjolbycity_20111031.gif" , 
                    //     Area = new AdvertiseArea { Company = new Company() {Name = "Bostadsbolaet AB", Url = "http://mjolbylunch.se", Information = "Lite företagsinfo..." }, LunchAreas = {l1} } },

                    //     new Advertise() { Image = 
                    //     "honhan_20110401.gif" , 
                    //     Area = new AdvertiseArea { Company = new Company() {Name = "Bostadsbolaet AB", Url = "http://mjolbylunch.se", Information = "Lite företagsinfo..." }, 
                    //         LunchAreas = {l1} } },

                    //     new Advertise() { Image = 
                    //     "blaklintsbuss_20120929.gif" , 
                    //     Area = new AdvertiseArea { Company = new Company() {Name = "Bostadsbolaet AB", Url = "http://mjolbylunch.se", Information = "Lite företagsinfo..." }, LunchAreas = {l1} } },
                    ...
                    //     new Advertise() { Image = 
                    //     "bostadsbolaget_20110916.gif" , 
                    //     Area = new AdvertiseArea { Company = new Company() {Name = "Bostadsbolaet AB", Url = "http://mjolbylunch.se", Information = "Lite företagsinfo..." }, LunchAreas = {l1} } },

                    //     new Advertise() { Image = 
                    //     "mjolbycity_20111031.gif" , 
                    //     Area = new AdvertiseArea { Company = new Company() {Name = "8Blåklintsbuss AB", Url = "http://mjolbylunch.se", Information = "Lite företagsinfo..." }, LunchAreas = {l1} } },

                    //     new Advertise() { Image = 
                    //     "honhan_20110401.gif" , 
                    //     Area = new AdvertiseArea { Company = new Company() {Name = "9Blåklintsbuss AB", Url = "http://mjolbylunch.se", Information = "Lite företagsinfo..." }, LunchAreas = {l1} } },

                    //     new Advertise() { Image = 
                    //     "mse_20091108.gif" , 
                    //     Area = new AdvertiseArea { Company = new Company() {Name = "12Blåklintsbuss AB", Url = "http://mjolbylunch.se", Information = "Lite företagsinfo..." }, LunchAreas = {l1} } },

                    //     new Advertise() { Image = 
                    //     "elda_20120323.gif" , 
                    //     Area = new AdvertiseArea { Company = new Company() {Name = "22Blåklintsbuss AB", Url = "http://mjolbylunch.se", Information = "Lite företagsinfo..." }, LunchAreas = {l1} } },

                    //     new Advertise() { Image = 
                    //     "bostadsbolaget_20110916.gif" , 
                    //     Area = new AdvertiseArea { Company = new Company() {Name = "33Blåklintsbuss AB", Url = "http://mjolbylunch.se", Information = "Lite företagsinfo..." }, LunchAreas = {l1} } },

                    //     new Advertise() { Image = 
                    //     "mse_20091108.gif" , 
                    //     Area = new AdvertiseArea { Company = new Company() {Name = "44Blåklintsbuss AB", Url = "http://mjolbylunch.se", Information = "Lite företagsinfo..." }, LunchAreas = {l1} } },

                    //     new Advertise() { Image = 
                    //     "elda_20120323.gif" , 
                    //     Area = new AdvertiseArea { Company = new Company() {Name = "55Blåklintsbuss AB", Url = "http://mjolbylunch.se", Information = "Lite företagsinfo..." }, LunchAreas = {l1} } },

                    //     new Advertise() { Image = 
                    //     "mjolbycity_20111031.gif" , 
                    //     Area = new AdvertiseArea { Company = new Company() {Name = "66Blåklintsbuss AB", Url = "http://mjolbylunch.se", Information = "Lite företagsinfo..." }, LunchAreas = {l1} } },

                    //     new Advertise() { Image = 
                    //     "honhan_20110401.gif" , 
                    //     Area = new AdvertiseArea { Company = new Company() {Name = "77Blåklintsbuss AB", Url = "http://mjolbylunch.se", Information = "Lite företagsinfo..." }, LunchAreas = {l1} } },

                    //     new Advertise() { Image = 
                    //     "blaklintsbuss_20120929.gif" , 
                    //     Area = new AdvertiseArea { Company = new Company() {Name = "88Blåklintsbuss AB", Url = "http://mjolbylunch.se", Information = "Lite företagsinfo..." }, LunchAreas = {l1} } },

                    //     new Advertise() { Image = 
                    //     "jockes_20091112.gif" , 
                    //     Area = new AdvertiseArea { Company = new Company() {Name = "99Blåklintsbuss AB", Url = "http://mjolbylunch.se", Information = "Lite företagsinfo..." }, LunchAreas = {l1} } },

                    //     new Advertise() { Image = 
                    //     "bostadsbolaget_20110916.gif" , 
                    //     Area = new AdvertiseArea { Company = new Company() {Name = "345Blåklintsbuss AB", Url = "http://mjolbylunch.se", Information = "Lite företagsinfo..." }, LunchAreas = {l1} } },

                    //     new Advertise() {Image = 
                    //     "mjolbycity_20111031.gif" , 
                    //     Area = new AdvertiseArea { Company = new Company() {Name = "233Blåklintsbuss AB", Url = "http://mjolbylunch.se", Information = "Lite företagsinfo..." }, LunchAreas = {l1} } },

                    //     new Advertise() {Image = "honhan_20110401.gif" , 
                    //     Area = new AdvertiseArea { Company = new Company() {Name = "1111Blåklintsbuss AB", Url = "http://mjolbylunch.se", Information = "Lite företagsinfo..." }, LunchAreas = {l1} } },

                    //     new Advertise() { Image = "mse_20091108.gif" , 
                    //     Area = new AdvertiseArea { Company = new Company() {Name = "1212Blåklintsbuss AB", Url = "http://mjolbylunch.se", Information = "Lite företagsinfo..." }, LunchAreas = {l1} } },

                    //     new Advertise() { Image = "elda_20120323.gif", 
                    //     Area = new AdvertiseArea { Company = new Company() {Name = "12121Blåklintsbuss AB", Url = "http://mjolbylunch.se", Information = "Lite företagsinfo..." }, LunchAreas = {l1} } },
                    // };
                }
            }
            ...
            foreach (var restaurant in restaurants)
            {
                ...
                CompanyManager.CreateCompany(cmp);
                restaurant.Company = cmp;
                //restaurant.Areas.Add(AdminManager.GetLunchAreaById(l1.Id));
                RestaurantManager.CreateRestaurant(restaurant, new List<long> {l1.Id, l2.Id});
                restaurant.Dishes = CreateDishes(restaurant);
                foreach (var dish in restaurant.Dishes)
                {
                    RestaurantManager.CreateDish(dish);
                }
            }
            ...
            foreach (var restaurant in restaurants)
            {
              ...
              //  var menu = RestaurantManager.CreateMenu(restaurant, weeknr, now, string.Format("Information för menun som gäller för vecka {0} ", weeknr));
                ...
                {
                   // menu.Days.Add(md);
                    RestaurantManager.CreateMenuDay(md);
                }
            }
        }
